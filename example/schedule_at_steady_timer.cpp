...
// g++ -std=c++23 -Wall -O3 -Os -s -I include -l uring example/schedule_at_steady_timer.cpp -o /tmp/schedule_at_steady_timer
...
int main(int argc, char* argv[])
{
    ...
    | unifex::then([&](int n)
      {
          timed_out = true;
          std::cout << "schedule_at steady_timer " << n << std::endl;
      })
