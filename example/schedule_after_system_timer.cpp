...
// g++ -std=c++23 -Wall -O3 -Os -s -I include -l uring example/schedule_after_system_timer.cpp -o /tmp/schedule_after_system_timer
...
int main(int argc, char* argv[])
{
    ...
    | unifex::then([&](int n)
      {
          timed_out = true;
          std::cout << "schedule_after system_timer " << n << std::endl;
      })
